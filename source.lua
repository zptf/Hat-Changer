...
function Hide()
	Debounce = true
	ThunderMadeLibrary:Notify({Title = "Interface Hidden", Content = "The interface has been hidden, you can unhide the interface by tapping on º SemiColom", Duration = 7})
